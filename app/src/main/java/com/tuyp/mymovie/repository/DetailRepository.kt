...
//    override fun getDetailMovie(movieId: String): LiveData<MovieDetail> {
//        val detailMovieData = MutableLiveData<MovieDetail>()
//        remoteDataSource.loadDetailMovie(movieId,object : RemoteDataSource.LoadMovieDetailCallback {
//            override fun loadDetailMovie(detailMovie: MovieDetail) {
//                if (detailMovie != null){
//                    detailMovieData.postValue(detailMovie)
//                }
//            }
...
//    }
//
//    override fun getDetailShow(showId: String): LiveData<TvShowDetail> {
//       val detailTvData = MutableLiveData<TvShowDetail>()
//        remoteDataSource.loadDetailShow(showId, object: RemoteDataSource.LoadShowDetailCallback {
//            override fun loadDetailShow(detailShow: TvShowDetail) {
//                if (detailShow != null) {
//                    detailTvData.postValue(detailShow)
//                }
//            }
//
//            override fun errorHanlding(message: String) {
//                errorMessageTvShow.postValue(message)
//            }
//
//        })
//        return detailTvData
