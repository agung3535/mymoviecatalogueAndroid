...
//    val errorMessageTvShow = MutableLiveData<String>()
    val isLoadingTv = MutableLiveData<Boolean>()
...
//    override fun getMovieList(): LiveData<List<MovieResource>> {
//        Log.d("dataaaa","panggil getmovie")
//        val movieResult = MutableLiveData<List<MovieResource>>()
//        remoteDataSource.loadMovie(object : RemoteDataSource.LoadMovieCallback {
//            override fun onAllMovieReceived(movieResponses: List<MovieResource>) {
//                movieResult.postValue(movieResponses)
//                Log.d("Dataaa","data = $movieResponses")
//                isLoading.postValue(false)
//            }
//
//            override fun errorHandling(message: String) {
//                Log.d("dataaa","error $message")
//                isLoading.postValue(false)
//                errorMessage.postValue("Gagal Memuat Data")
//            }
//
//        })
//
...
//    override fun getTvShow(): LiveData<List<TvShowResource>> {
//        val tvShow = MutableLiveData<List<TvShowResource>>()
//        remoteDataSource.loadTv(object : RemoteDataSource.LoadTvShowCallback {
//            override fun onAllTvShowReceiverd(showResponse: List<TvShowResource>) {
//                tvShow.postValue(showResponse)
//                isLoadingTv.postValue(false)
//            }
//
//            override fun errorHanlding(message: String) {
//                isLoadingTv.postValue(false)
//                errorMessageTvShow.postValue("Gagal memuat data")
//            }
//
//        })
//
